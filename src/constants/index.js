...
const experiences = [
  {
    ...
    points: [
      ...
      "Executed pentitration attacks and reverse engineering to identify and fix security vulnerabilities.",
    ],
  },
  {
    title: "Full-Stack Developer",
    ...
    points: [
      ...
      "Made a responsive website with dynamic content and user-friendly interface.",
    ],
  },
  {
    title: "Full-Stack Developer",
    ...
    points: [
      ...
      "Better resoponse time and user experience using the activve feedback and the user active chatbot.",
    ],
  },
  {
    ...
    points: [
      ...
      "Designed and implemented a scalable backend service utilizing MongoDB and FastAPI, following a test-driven development approach, ensuring a stable and well-tested codebase.",
      "Implemented secure user authentication by integrating Simple JWT, ensuring secure access to sensitive user information and a seamless user experience.",
      "Managed all the backend services and databases.",
    ],
  },
  // {
...
const testimonials = [
  {
    testimonial:
      "I can't say enough good things about Utsab. He's a true team player who always puts the needs of the project first. If you're looking for a software engineer who can deliver results, Utsab is your guy.",
    name: "Halley Bennett",
    designation: "",
  ...
  {
    testimonial:
      "Utsab is an incredible problem solver. Whenever we ran into a roadblock on our project, he was always able to come up with creative solutions that kept us moving forward.",
    name: "Yishak Wesego",
    designation: "",
    company: "Hack Reactor",
  ...
  {
    testimonial:
      "I've worked with a lot of engineers over the years, and Utsab is one of the best. His technical skills are top-notch, but what really sets him apart is his ability to communicate complex ideas in a way that everyone on the team can understand.",
    name: "Megan Stewart",
    designation: "",
    company: "Hack Reactor",
...
const imageProjects = [
  {
    ...
    title: "Madamcoon Maine Coon Cattery",
    description: "",
  },
  {
    id: 2,
...
const projects = [
  {
    ...
    image: smartrep,
    source_code_link: "https://github.com/conceptqubit/Gesture.git",
